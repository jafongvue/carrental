...
<head>
  ...
  <!-- <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/images/"> -->
  <!-- <link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/images/"> -->
  <link rel="apple-touch-icon-precomposed" href="assets/images/favicon-icon/apple-touch-icon-57-precomposed.png">
  <link rel="shortcut icon" href="assets/images/carlogo.jpg">
  ...
  <section class="section-padding gray-bg">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p>There are many car for you to booking.</p>
      </div>
      <div class="row">
          ...
          if ($query->rowCount() > 0) {
            foreach ($results as $result) { ?>
              <div class="testimonial-m">
                <div class="testimonial-img"> <img src="assets/images/599305.png" alt="" /> </div>
